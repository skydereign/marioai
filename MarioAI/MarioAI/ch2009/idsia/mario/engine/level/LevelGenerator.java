package ch2009.idsia.mario.engine.level;

import ch2009.idsia.mario.engine.sprites.Enemy;
...
public class LevelGenerator
{
    ...
    public static void fixWalls(Level level)
    {
    	//
        boolean[][] blockMap = new boolean[level.width + 1][level.height + 1];
        ...
        sblockify(level, blockMap, level.width + 1, level.height + 1);
    }

    public static void sblockify(Level level, boolean[][] blocks, int width, int height)
    {
        int to = 0;
